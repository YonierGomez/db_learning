...
-- Actualizar las ventas de algunos libros
UPDATE libros SET ventas = 500000 WHERE titulo = 'Carrie';
UPDATE libros SET ventas = 450000 WHERE titulo = 'El misterio de Salmes Lot';
UPDATE libros SET ventas = 600000 WHERE titulo = 'El resplando';
UPDATE libros SET ventas = 300000 WHERE titulo = 'Rabia';
UPDATE libros SET ventas = 700000 WHERE titulo = 'Harry Potter y la Piedra Filosofal';
UPDATE libros SET ventas = 650000 WHERE titulo = 'Harry Potter y la Cámara Secreta';
UPDATE libros SET ventas = 800000 WHERE titulo = 'Harry Potter y el Prisionero de Azkaban';

-- Consulta para obtener el autor con mayor ventas en promedio
SELECT a.nombre, a.apellido, AVG(l.ventas) AS promedio_ventas
FROM autores a
